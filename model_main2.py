...
from models5 import cqt_mgd#,em_param,em_param2
...
def evaluate_accuracy(data_loader, model,device): #有效性
    ...
    for batch_x, batch_y, batch_meta in tqdm(data_loader):
        ...
        batch_out=model(batch_x,batch_x,device)
        #x,y,fai_x,fai_y,T,Q,m,mu_y,fai,batch_out,emb=model(batch_x,batch_x,device)
...
if __name__ == '__main__':
    ...
    dev_loader = DataLoader(dev_set, batch_size=args.batch_size,shuffle=True,pin_memory=True,num_workers=64)
